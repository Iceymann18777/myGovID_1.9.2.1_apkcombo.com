.class public Lcom/ocrlabs/orbit/mrz/e0;
...
.method public static a([BLandroid/hardware/Camera$Parameters;)Landroid/graphics/Bitmap;
    .registers 11
    ...
    invoke-static {p1, v3, v5, v1}, Landroid/graphics/BitmapFactory;->decodeByteArray([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    move-result-object v4

    invoke-virtual {p0}, Ljava/io/ByteArrayOutputStream;->close()V
    :try_end_45
    .catch Ljava/lang/OutOfMemoryError; {:try_start_3d .. :try_end_45} :catch_49
    .catch Ljava/io/IOException; {:try_start_3d .. :try_end_45} :catch_46

    goto :goto_54

    :catch_46
    const-string v5, "IOException convertYuvByteArrayToBitmap"

    goto :goto_4b

    :catch_49
    const-string v5, "OutOfMemoryError convertYuvByteArrayToBitmap"
...
.method public static a([BLandroid/hardware/Camera;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p1, v4, v4, v3, v2}, Landroid/graphics/Rect;-><init>(IIII)V

    const/16 v2, 0x64

    invoke-virtual {v9, p1, v2, p0}, Landroid/graphics/YuvImage;->compressToJpeg(Landroid/graphics/Rect;ILjava/io/OutputStream;)Z
    ...
    invoke-virtual {p0}, Ljava/io/ByteArrayOutputStream;->close()V
    :try_end_4e
    .catch Ljava/lang/OutOfMemoryError; {:try_start_46 .. :try_end_4e} :catch_52
...
.method public static a(Landroid/graphics/Bitmap;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Lcom/ocrlabs/orbit/mrz/x0;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
...
.method public static a(Landroid/graphics/Rect;[BLjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2, v0}, Lcom/ocrlabs/orbit/mrz/x0;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
...
.method public static b(Ljava/lang/String;)I
    ...
    move-result p0
    :try_end_c
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_c} :catch_20
...
.method public static b(Landroid/graphics/Bitmap;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/ocrlabs/orbit/mrz/e0;->a(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v0, p0}, Lcom/ocrlabs/orbit/mrz/l;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Ljava/io/FileOutputStream;->close()V
    :try_end_1d
    .catch Ljava/io/FileNotFoundException; {:try_start_e .. :try_end_1d} :catch_2e
...
.method public static b([BLjava/lang/String;)V
    ...
    :try_end_21
    .catch Ljava/io/FileNotFoundException; {:try_start_e .. :try_end_21} :catch_32
